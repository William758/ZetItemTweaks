...
namespace TPDespair.ZetItemTweaks
{
	...
	{
		public static List<string> autoCompatList = new List<string> { "com.RiskyLives.RiskyMod", "com.kking117.FlatItemBuff", "Hayaku.VanillaRebalance", "OakPrime.HuntersHarpoonRework", "com.Wolfo.RoRRHuntersHarpoon", "com.Wolfo.WolfoItemBuffs" };
